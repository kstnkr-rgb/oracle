...
const COOKIE_SYSTEM_PROMPT = `Ты генерируешь предсказания для печенья с предсказанием. Создай одно позитивное, доброе и короткое предсказание. Максимум 100 знаков. Только текст предсказания без кавычек, заголовков и пояснений. Никогда не пиши, что не можешь предсказать.`;
